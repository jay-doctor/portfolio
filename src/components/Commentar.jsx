...
import { getDocs, addDoc, collection, onSnapshot, query, orderBy, serverTimestamp } from 'firebase/firestore'; // For storing App data (users, posts, etc)
import { ref, uploadBytes, getDownloadURL } from 'firebase/storage'; // For storing Data Type - Files (images, PDFs)
...
const Komentar = () => {
    ...
    useEffect(() => {
        ...
        return onSnapshot(q, (querySnapshot) => {
            ...
            // setComments(commentsData); // Temporary Commented Comments part by Jay D. 
            setComments(""); // Added by Jay D.
        });
    }, []);
