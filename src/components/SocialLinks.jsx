...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/jay-doctor-140182120/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@j.d.doctor",
    icon: Instagram,
    url: "https://www.instagram.com/j.d.doctor?igsh=MXh1NWJ2eHZjNW1idA==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@jay-doctor",
    icon: Github,
    url: "https://github.com/jay-doctor",
    color: "#ffffff",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          ...
          {[github].map((link) => (
            <a
              ...
              //          bg-white/5 border border-white/10 overflow-hidden
              //          hover:border-white/20 transition-all duration-500"
              className="group relative flex items-center justify-between gap-3 p-5 rounded-lg 
                          bg-white/5 border border-white/10 overflow-hidden
                          hover:border-white/20 transition-all duration-500"
            >
              <div className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500
        ...
        {/* Fourth Row - Instagram */}
        {/* Created by Jay Doctor */}
        <div>
